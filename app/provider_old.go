...
// ProviderOld provides a standard interface to run commands against an app
...
//   - Each ProviderOld is specific to Category+Type (Example: category=app/container, type=service/aws-fargate)
type ProviderOld interface {
