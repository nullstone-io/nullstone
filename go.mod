...
require (
	...
	github.com/nullstone-io/deployment-sdk v0.0.0-20260204173150-35dca3be751c
	...
	gopkg.in/nullstone-io/go-api-client.v0 v0.0.0-20260204203816-ab9191669460
	k8s.io/api v0.35.0
...
require (
	...
	sigs.k8s.io/aws-iam-authenticator v0.7.10 // indirect
