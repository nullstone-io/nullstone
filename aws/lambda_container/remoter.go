...
import (
	...
	lambda_container "github.com/nullstone-io/deployment-sdk/aws/lambda-container"
...
func NewRemoter(osWriters logging.OsWriters, nsConfig api.Config, appDetails app.Details) (admin.Remoter, error) {
	outs, err := outputs.Retrieve[lambda_container.Outputs](nsConfig, appDetails.Workspace)
	if err != nil {
		return nil, err
	}
...
type Remoter struct {
	...
	Details   app.Details
	Infra     lambda_container.Outputs
}
